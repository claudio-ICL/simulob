...
class OrderQueue: public std::deque<std::shared_ptr<Order>> , public Controller{
  public:
...
class OrderBook: public tController{
  public:
    OrderBook(int ticksize=100, int opening_bidprice=100000, int opening_askprice=100500);
    ...
    static MatchRes match_orders(std::shared_ptr<Order>&, std::shared_ptr<Order>&);
